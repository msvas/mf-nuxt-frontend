    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <div class="row align-items-center" style="background: white; position: sticky; top: 0; z-index: 800;">
              ...
              <div class="m-0 pr-0" style="padding-top: 10px; padding-bottom: 5px; padding-left: 1rem; flex: 0 0 58%; max-width: 58%;">
                ...
                <br />
                <vs-button @click="shareOnWhatsapp()"
                  color="#00bfa5"
                  type="filled"
          ...
          <div v-if="supplierOfferProducts && supplierOfferProducts.length" style="background: #EDEDED; border-bottom: solid 1px #D5D5D5;">
              ...
              >
                ...
                >
                  ...
                  >
                    <a @click="openNavigationsModal('collection', selectedFamily)">
                      {{ index }}
                ...
                >
                  ...
                  >
                    <a @click="openNavigationsModal('category-all-products', selectedFamily)">
                      {{ selectedCategory }}
          ...
          <div v-else style="background: #EDEDED; border-bottom: solid 1px #D5D5D5;">
              <div class="navigations-container">
                <div class="w-100 d-flex no-wrap">
                  ...
                  <div style="width: 40%;">
                    <form @submit.prevent="runSupplierSearch()" style="margin-left: 10px;">
                      <input
                        id="search2"
                        type="text"
                        placeholder="Buscar..."
              ...
              <div v-if="viewType == 'product-type' && (productsFromType(selectedProductType).length > 1 || hasFilters(selectedProductType))"
                class="navigations-container"
                style="justify-content: flex-end;"
              >
                      ...
                      <div v-if="viewType == 'family'">
                        ...
                        >
                          ...
                          >
                            ...
                            <div class="pl-2 m-0 p-0 pt-2">
                              <a href="javascript:void(0)" @click="goToOffers()">Ver tudo</a>
                            </div>
                          </div>
                          <div
                            class="row pl-1"
                            :style="'padding-top: 10px; background-color: #ebebeb; overflow-x: scroll; width: ' + calcWidth(supplierOfferProducts.slice(0, 6).length) + 'px;'"
                          >
                            <span
                      ...
                      <div v-if="viewType == 'category-all-products'" ref="categoryAllScroll" style>
                        ...
                        >
                          <div class="col-12 p-0 m-0">
                            <div
                              class="row justify-content-center"
                              style="margin-top: 10px; padding-bottom: 3rem; overflow-x: hidden;"
                            >
                              <span
                          ...
                          <b-pagination
                            ...
                            :total-rows="categoryAllProductsTotalPages * maxPerScreenProductType * (maxLines + 2)"
          ...
          <div class="row" style="z-index: 1000; padding: 5px 20px 0px 20px; background-color: white; position: -webkit-sticky; position: sticky; top: 0px;">
           ...
           <div style=" background: #ededed; border-bottom: solid 1px #d5d5d5;">
            ...
            <div
              ...
              class="navigatios-container"
              v-if="viewType == 'product-type' && (productsFromType(selectedProductType).length > 1 || hasFilters(selectedProductType))"
            >
                    ...
                    <div>
                      ...
                      <div v-if="viewType == 'family'" style>
                        ...
                        >
                          ...
                          <div
                            class="row pl-1"
                            :style="'padding-top: 10px; background-color: #ebebeb;'"
                          >
                            <span
...
export default {
  ...
  methods: {
    ...
    productsFromType(type, filtering = false) {
      if (this.supplierProducts && this.supplierProducts.length)
        return this.supplierProducts.filter((prod) => prod.productTypeId == type.productTypeId)
      else
        return []
    },
    updateSidebar(val) {
    ...
    updateProductsByFilters(filters) {
      ...
      if (filters.brands.length || filters.volumes.length || filters.tags.length || filters.properties.length) {
        ...
        this.getCatalogByProductTypeAndSupplierPaginated({ productTypeId: this.selectedProductType.productTypeId, supplierId: this.supplier.id, filters: filters, items: this.maxPerScreenProductType * this.maxLines }).then(() => {
          this.isLoading = false;
          this.loading = false;
        });
      } else {
        this.getCatalogByProductTypeAndSupplierPaginated({ productTypeId: this.selectedProductType.productTypeId, supplierId: this.supplier.id, filters: {}, items: this.maxPerScreenProductType * this.maxLines }).then(() => {
          this.isLoading = false;
          this.loading = false;
        });
      }
    ...
    clearAllFilters() {
      ...
      this.getCatalogByProductTypeAndSupplierPaginated({ productTypeId: this.selectedProductType.productTypeId, supplierId: this.supplier.id, filters: this.activeFilters, items: this.maxPerScreenProductType * this.maxLines }).then(() => {
        this.isLoading = false;
        this.loading = false;
      })
    },
